...
class VsqxConverter:
    ...
    vsqx_file: Optional[etree._ElementTree]
    convert_file: Optional[Dict[str, str]]

    def __init__(self, vsqx_file: Optional[etree._ElementTree] = None, convert_file: Optional[Dict[str, str]] = None) -> None:
        self.vsqx_file = vsqx_file
        self.convert_file = convert_file

    def convert(self, vsqx_file: Optional[etree._ElementTree] = None, convert_file: Optional[Dict[str, str]] = None) -> bytes:
        ...
        for note in root.findall(".//v4:note/v4:p", namespaces=VsqxConverter.NS):
            origin_note: Optional[str] = note.text
